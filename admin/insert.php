...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($conn, "INSERT INTO `HubTracker`( `bookingId`, `trackingId`, `date`, `status`) VALUES
     ('$bookingId','$rfid','$date','$status')");
    if ($query) {
...
<div class="signup-form">
   ...
   <?php } ?>
			    <!--<input type="text" class="form-control" name="bookingId" placeholder="Booking Id" required="true">-->
		</div>
