...
<form action="?" method="post" enctype="multipart/form-data">
      ...
      <tr><th  style="background-color:pink; font-size:17px; font-weight:bold; text-align:center; color:black;" colspan="11">View Railway Receipt</th></tr>        
                       <tr>
...
while ($row5 = mysqli_fetch_array($result5)) {
    ...
    //echo $req_id;
                                $link2="/DD2DD/customer/rr_gen.php?Id=".$bookingId;
                                //echo  $link2;
...
?> 
                        ...
                        <td ><?php echo $row5[''] ?></td> 
                        <td><a style= "color:blue;" onclick="window.open('<?php echo $link2;?>','popup','width=1500,height=1500'); return false;">View RR</a></td>
