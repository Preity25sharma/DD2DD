...
<html>
 <head>
    ...
    <script src="https://apis.mapmyindia.com/advancedmaps/v1/1bf84938-554e-4c86-aca8-84a29b051923/map_load?v=1.5"></script>
    <script src="https://apis.mapmyindia.com/advancedmaps/api/1bf84938-554e-4c86-aca8-84a29b051923/map_sdk_plugins"></script>
    <style>
        body{margin: 0}
        #map{
        ...
        <script>
         ...
         // var map = new MapmyIndia.Map('map', {center: [28.09, 78.3], zoom: 5, search: false});
          ...
          /*Search plugin initialization*/
            ...
            MapmyIndia.search(document.getElementById("autocomplete1"),optional_config,callback);
