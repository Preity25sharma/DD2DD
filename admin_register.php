...
if (isset($_POST['submit'])) {
    ...
    $register_type= $_POST['register_type'];
     ...
     // $firstName=REPLACE($username, SUBSTRING_INDEX($username, ' ', -1),'');
     //$lastName=SUBSTRING_INDEX($username, ' ', -1) ;
     
     //SELECT 
    //if( INSTR(`firstName`, ' ')=0, 
    // TRIM(SUBSTRING('$username', INSTR('$username', ' ')+1));
    //TRIM(SUBSTRING('$username', 1, INSTR('$username', ' ')-1));
   //if( INSTR(`firstName`, ' ')=0, 
  //  null, 
  //  TRIM(SUBSTRING(`firstName`, INSTR(`firstName`, ' ')+1)) ) last_name FROM User
