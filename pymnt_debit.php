...
<div class="container bg-light d-md-flex align-items-center">
    <div class="card box1 shadow-sm p-md-5 p-md-5 p-4">
        ...
        <div class="d-flex flex-column">
            <div class="d-flex align-items-center justify-content-between text"> <span class="">Commission</span> <span class="fas fa-rupee-sign"><span class="ps-1">45</span></span> </div>
    ...
    <div class="card box2 shadow-sm">
        ...
        <ul class="nav nav-tabs mb-3 px-md-4 px-2">
            ...
            <li class="nav-item"> <a class="nav-link px-2 active" aria-current="page" href="pymnt_debit.php">Debit Card</a> </li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column ps-md-5  px-4 mb-4">
                        <div class="inputWithIcon"> <input type="text" class="form-control" placeholder="Expiry Date" ></div>
                    </div>
                </div>
                <div class="col-md-6">
